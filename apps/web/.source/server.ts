// @ts-nocheck
import * as __fd_glob_20 from "../content/docs/ui/utilities/hooks/use-share.mdx?collection=docs"
import * as __fd_glob_19 from "../content/docs/ui/utilities/hooks/use-platform.mdx?collection=docs"
import * as __fd_glob_18 from "../content/docs/ui/blocks/navs/start-end.mdx?collection=docs"
...
import * as __fd_glob_15 from "../content/docs/ui/blocks/heroes/simple-centered.mdx?collection=docs"
import * as __fd_glob_14 from "../content/docs/ui/primitives/typography.mdx?collection=docs"
import * as __fd_glob_13 from "../content/docs/ui/primitives/tooltip-ui.mdx?collection=docs"
import * as __fd_glob_12 from "../content/docs/ui/primitives/theme-toggles.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/ui/primitives/social-share.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"cli/meta.json": __fd_glob_1, "ui/meta.json": __fd_glob_2, }, {"cli/index.mdx": __fd_glob_3, "ui/index.mdx": __fd_glob_4, "ui/installation.mdx": __fd_glob_5, "ui/motion/scroll-animations.mdx": __fd_glob_6, "ui/primitives/backgrounds.mdx": __fd_glob_7, "ui/primitives/popover-ui.mdx": __fd_glob_8, "ui/primitives/section.mdx": __fd_glob_9, "ui/primitives/shadcn-radix.mdx": __fd_glob_10, "ui/primitives/social-share.mdx": __fd_glob_11, "ui/primitives/theme-toggles.mdx": __fd_glob_12, "ui/primitives/tooltip-ui.mdx": __fd_glob_13, "ui/primitives/typography.mdx": __fd_glob_14, "ui/blocks/heroes/simple-centered.mdx": __fd_glob_15, "ui/blocks/sheets/basic-sheet.mdx": __fd_glob_16, "ui/blocks/sheets/mintlify-sheet.mdx": __fd_glob_17, "ui/blocks/navs/start-end.mdx": __fd_glob_18, "ui/utilities/hooks/use-platform.mdx": __fd_glob_19, "ui/utilities/hooks/use-share.mdx": __fd_glob_20, });