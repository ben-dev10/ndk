...
export const index: Record<string, any> = {
  ...
  "components-social-share": {
    ...
    dependencies: ["lucide-react"],
    devDependencies: undefined,
    registryDependencies: ["button","popover","@ndk/components-social-icons"],
    files: [
  {
  ...
  "hooks-use-clipboard": {
    ...
    description: "Copies a resource to clipboard",
    type: "registry:hook",
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: undefined,
    files: [
  {
    "path": "registry/hooks/use-clipboard/index.ts",
    "type": "registry:hook",
    "target": "hooks/use-clipboard.ts",
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/hooks/use-clipboard/index.ts");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "hooks-use-clipboard";
        const Comp = mod.default || mod[exportName];
    ...
    command: '@ndk/hooks-use-clipboard',
  },
  "hooks-use-open": {
    name: "hooks-use-open",
