...
export default function Home() {
  return (
    <main className="grid min-h-screen place-items-center p-20">
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-muted-foreground">
                    Most ui components provided by the @ndk/ui package are just
                    plain shadcn components bundled up into a neat small package
                    along with other helpful tools and utilities.
                  </DialogDescription>
                  <div className="mt-5">
                    <ThemeImage
